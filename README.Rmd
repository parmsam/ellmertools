...
Check out the [btw package](https://github.com/posit-dev/btw/) for a more comprehensive set of tools to describe R Stuff to Large Language Models using ellmer.
